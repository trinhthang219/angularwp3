...
import { AppSettings } from '../../core/appsetting/app.setting';
@Injectable()
export class CustomerServices implements ICustomerServices {
  // private headers = new Headers({'Content-Type': 'application/json'});
  public customerApiUrl : string =  AppSettings.API_CUSTOMER_ENDPOINT ;//'https://thaisp2016.xspera.net:5443/Customer/Get'; //(<any>window)._spPageContextInfo.webAbsoluteUrl + "/_vti_bin/Xspera.Portal.Menu/SPMenuService.svc/GetAllQuickLinks";
